  ...
  const cards: Array<{
    ...
    },
    {
      ...
      tip: provider.hasReasoningTokens
        ...
        : // No residue caveat here, and "see the note above" pointed at a notice
          // removed long ago. The UI deliberately says nothing about the
          // output-token residue - it is a fraction of a thousandth of a
          // percent, on the cheapest model - and a tooltip hedging every figure
          // is the banner that decision rejected, in smaller type. See
          // CLAUDE.md, "The residue is real but immaterial".
